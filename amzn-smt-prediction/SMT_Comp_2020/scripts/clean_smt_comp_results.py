...
if __name__=='__main__':
    ...
    fp_disagreed_slia  = open("../excluded_benchmarks/disagreements_SLIA")
    fp_excluded_slia   = open("../excluded_benchmarks/excluded_SLIA")
    ...
    fp_out1 = open("../benchmarks_QF_SLIA_30-to-300.csv", 'w')
    fp_out2 = open("../times_QF_SLIA_30-to-300.csv", 'w')

    fp_out3 = open("../benchmarks_QF_SLIA_300-to-1200.csv", 'w')
    fp_out4 = open("../times_QF_SLIA_300-to-1200.csv", 'w')
